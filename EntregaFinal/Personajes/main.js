      ...
      // agregar una robusta imagen de respaldo en caso de que la imagen remota no se cargue
        ...
        if (imgEl) {
            imgEl.addEventListener('error', () => {
                imgEl.onerror = null;
                imgEl.src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200"><rect width="100%" height="100%" fill="%231a1a2e"/><text x="50%" y="50%" fill="%23e5b22b" font-size="18" font-family="Arial, Helvetica, sans-serif" text-anchor="middle" dominant-baseline="middle">Imagen no disponible</text></svg>';
            });
        }
